...
public:
	...
	//
	virtual ~Toy() {
		cout << "Toy destruktorius\n"; //kad matytumėt, jog bazinis objektas naikinamas
	}                                      
	//
...
public:
	...
	~Doll() {
		cout << "Doll destruktorius\n"; //kad matytumėt, jog Doll objektas naikinamas
	}                                        
	void getData() {
...
public:
	...
	~Soldier() {
		cout << "Soldier destruktorius\n"; //kad matytumėt, jog Sodiers objektas naikinamas
	}                                       
	void getData() {
...
int main() {
	...
	//
	for (size_t i = 0; i < n; i++) delete toys[i];  //išlaisvinama kiekvieno dinaminio objekto atmintis
	delete[] toys;    //išlaisvinama rodyklių masyvo atmintis 
	//
}
